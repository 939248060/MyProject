...
<title>添加员工</title>
<link type="text/css" rel="styleSheet"  href="css/EmpAdd.css" />
...
<body>
<a href="Emp-Sh-owEmp.action" class="title">员工列表</a><span class="title">-> 员工添加</span>
<s:form action="Emp-Sava-AddEmp.action" method="post">
<s:hidden name="ep.id" value="%{ep.id}"></s:hidden>
   <table class="table">
    <tr>
     <td><s:textfield name="ep.eid" label="ID"></s:textfield></td>
    </tr>
    <tr>
