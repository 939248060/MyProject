...
<div id="wrapper">
	<div id="header">
		...
		<div id="heading">
			...
			<div id="subTitle">Verion 3.0</div>
		</div>
	</div>
	<div id="main">
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					<s:form name="loginForm" action="Users_login.action" method="post" namespace="/">
					<!-- start of login form -->
					<div id="welcome">
	...
	<div id="footer">
		<div id="text">Copyright © 2009-2018 All Rights Reserved Powered By SOUL开发小组</div>
	</div>
</div>
</body>
</html>