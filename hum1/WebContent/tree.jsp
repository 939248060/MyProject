...
var treeMenu = [
	{ level:1, name:"员工管理"},
	{ level:2, name:"员工列表", ico:"images/icon_default.gif",link:"Emp-Sh-owEmp.action"},
	{ level:1, name:"部门管理"},
	{ level:2, name:"部门列表", ico:"images/icon_default.gif",link:"Dep-Sh-owDep.action"},
	{ level:1, name:"学历管理"},
	{ level:2, name:"学历列表", ico:"images/icon_default.gif",link:"Edu-findAll.action"},
	{ level:1, name:"员工配偶管理"},
	{ level:2, name:"配偶列表", ico:"images/icon_default.gif",link:"Spo-showAllSpo.action"},
	{ level:1, name:"信息管理"},
...
<div id="menuControll">
菜单控制:【<a href="#" onclick="tree.openAll();this.blur();" style="color:#333333;text-decoration:none">展开</a>】
【<a href="#" onclick="tree.closeAll();this.blur();" style="color:#333333;text-decoration:none">折叠</a>】
</div>
